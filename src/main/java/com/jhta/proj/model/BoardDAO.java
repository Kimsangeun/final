...
public class BoardDAO {
	...
	public Object maxBid(BoardVO bvo) {
		Object ii = sessionTemplate.insert("boardMapper.maxbid", bvo);
	 ...
	 * 
	 * map.put("start", start); map.put("end", end); map.put("kind", kind);
	 * map.put("vo", bvo); System.out.println("다오맵"+map); return
	 * sessionTemplate.selectList("boardMapper.someList", map);
	 * 
	 * }
	 */
}
