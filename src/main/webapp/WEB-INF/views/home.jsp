...
<html >
  <head>
   ...
   <!--  <link href="/proj/resources/bootstrap-3.2.0-dist/css/dashboard.css" rel="stylesheet"> -->
    <link href="/proj/resources/bootstrap-3.2.0-dist/css/carousel.css" rel="stylesheet">
  </head>
<!-- NAVBAR
================================================== -->
  <body>
          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">예매 <span class="caret"></span></a>
                  <ul class="dropdown-menu" role="menu">
...
<!--     <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
    ...
    <script type="text/javascript" src="/proj/resources/bootstrap-3.2.0-dist/js/holder.js"></script>
